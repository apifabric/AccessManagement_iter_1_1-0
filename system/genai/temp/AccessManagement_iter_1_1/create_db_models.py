...
try:
    ...
    session.commit()
    user1 = User(id=1, name="Alice", is_special_user=True, group_id=1, profile_id=1, access_count=2, invitation_count=1)
    user2 = User(id=2, name="Bob", is_special_user=False, group_id=2, profile_id=2, access_count=1, invitation_count=1)
    user3 = User(id=3, name="Charlie", is_special_user=True, group_id=1, profile_id=1, access_count=1, invitation_count=1)
    user4 = User(id=4, name="David", is_special_user=False, group_id=2, profile_id=2, access_count=1, invitation_count=1)
