...
resourcename="accessmanagementiter11"  # lower case, only
resourcegroup="accessmanagementiter11_rg"
...
# git clone https://github.com/apilogicserver/accessmanagementiter11.git
# cd accessmanagementiter11
...
az group create --name accessmanagementiter11_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group accessmanagementiter11_rg --sku S1 --is-linux
az container create --resource-group accessmanagementiter11_rg --name accessmanagementiter11 --image apilogicserver/accessmanagementiter11:latest --dns-name-label accessmanagementiter11 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//accessmanagementiter11.westus.azurecontainer.io:5656'
